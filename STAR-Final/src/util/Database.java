...
//			System.out.println("Course Index Found"); //COMMENTED BY JY
		} catch(IOException e) 
		{
			System.out.println("File Error.");
			e.printStackTrace();
		}
		System.out.println("Course Index Not Found!!!"); //COMMENTED BY JY
		return false;
	}
