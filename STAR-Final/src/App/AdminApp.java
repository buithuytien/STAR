...
//					studMatric = sc.next();	
//					//ADDED BY JY
//					char type = pm.checkPplType(studMatric);
//					while (type != 'S') {
//						System.out.print("Incorrect student matric. Please enter student matric number again: ");
//						studMatric = sc.next();	
//						type = pm.checkPplType(studMatric);
//					}
...
//				} while(studMatric == null);
				...
				s.setStudNum(phone);
//				//CAN ADD ERROR EXCEPTION FOR THEM. COMMENTS FROM JY
//				System.out.print("Enter student name ");
//				name = sc.next();
